...
/***/ function(module, exports, __webpack_require__) {
	...
	document.write('<pre>');
	document.write(JSON.stringify(_item2.default));
	document.write('</pre>');
	console.log("test", _item2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _testController = __webpack_require__(2);

	var _controller = __webpack_require__(5);

	exports.default = {
		"pie-one": new _testController.Controller(),
		"pie-two": new _controller.Controller()
	};
	...
	var Controller = exports.Controller = function () {
	  ...
	  _createClass(Controller, [{
	    ...
	    value: function model(question, session, env) {
	      ...
	      _lodash2.default.forEach([1, 2, 3], console.log);
	    }
	  }, {
	    key: "outcome",
	    value: function outcome(question, session, env) {
...
/***/ function(module, exports) {
	...
	var Controller = exports.Controller = function () {
	  ...
	  _createClass(Controller, [{
	    key: "model",
	    value: function model(question, session, env) {
	      console.log("[pie-two controller] model");
	    }
	  }, {
	    key: "outcome",
	    value: function outcome(question, session, env) {
	      console.log("[pie-two controller] outcome");
	    }
	  }]);
